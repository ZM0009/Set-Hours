...
- Closing or cancelling the manual-shift form no longer creates a shift.
- Saved shifts can now be deleted by opening the day in Timesheet and tapping **Delete Shift**.
- Existing local timesheet data is preserved when updating the GitHub files.
